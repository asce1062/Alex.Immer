...
public class PlayerThread extends Thread {
    ...
    public static final String VERS = "1.0.6.2";
    ...
    private boolean GetAndroidAudioTrack(int desiredrate) {
        ...
        if (desiredrate == 0) {
            ...
            while (!success && (rateindex < NUM_RATES)) {
                try {
                    mMinbuffer = AudioTrack.getMinBufferSize(try_rates[rateindex], AudioFormat.CHANNEL_OUT_STEREO, AudioFormat.ENCODING_PCM_16BIT);
                    Log.i(LOGPREFIX, "mMinbuffer=" + mMinbuffer + " our BUFFERSIZE=" + BUFFERSIZE);
                    mMytrack = new AudioTrack(AudioManager.STREAM_MUSIC, try_rates[rateindex], AudioFormat.CHANNEL_OUT_STEREO,
            ...
            mMinbuffer = AudioTrack.getMinBufferSize(desiredrate, AudioFormat.CHANNEL_OUT_STEREO, AudioFormat.ENCODING_PCM_16BIT);
            Log.i(LOGPREFIX, "mMinbuffer=" + mMinbuffer + " our BUFFERSIZE=" + BUFFERSIZE);
            mMytrack = new AudioTrack(AudioManager.STREAM_MUSIC, desiredrate, AudioFormat.CHANNEL_OUT_STEREO,
                    AudioFormat.ENCODING_PCM_16BIT, mMinbuffer, AudioTrack.MODE_STREAM);
            // init the Modplug player for this sample rate
        ...
        if (mMytrack == null) {
            ...
            switch (mMytrack.getState()) {
                ...
                default:
                    ...
                    mMytrack = new AudioTrack(AudioManager.STREAM_MUSIC, mRate, AudioFormat.CHANNEL_OUT_STEREO,
